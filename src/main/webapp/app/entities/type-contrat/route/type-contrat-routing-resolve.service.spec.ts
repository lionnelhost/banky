...
describe('TypeContrat routing resolve service', () => {
  ...
  describe('resolve', () => {
    it('should return ITypeContrat returned by find', () => {
      // GIVEN
      service.find = jest.fn(idTypeContrat => of(new HttpResponse({ body: { idTypeContrat } })));
      mockActivatedRouteSnapshot.params = { idTypeContrat: 'ABC' };
      ...
      expect(resultTypeContrat).toEqual({ idTypeContrat: 'ABC' });
    });
