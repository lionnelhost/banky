...
describe('TypeContrat Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should update editForm', () => {
      const typeContrat: ITypeContrat = { idTypeContrat: 'CBA' };
  ...
  describe('save', () => {
    it('Should call update service on save for existing entity', () => {
      ...
      const typeContrat = { idTypeContrat: 'ABC' };
    ...
    it('Should call create service on save for new entity', () => {
      ...
      const saveSubject = new Subject<HttpResponse<ITypeContrat>>();
      const typeContrat = { idTypeContrat: 'ABC' };
      jest.spyOn(typeContratFormService, 'getTypeContrat').mockReturnValue({ idTypeContrat: null });
