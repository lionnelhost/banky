...
export type PartialUpdateTypeContrat = Partial<ITypeContrat> & Pick<ITypeContrat, 'idTypeContrat'>;
...
export class TypeContratService {
  ...
  getTypeContratIdentifier(typeContrat: Pick<ITypeContrat, 'idTypeContrat'>): string {
    return typeContrat.idTypeContrat;
  }

  compareTypeContrat(o1: Pick<ITypeContrat, 'idTypeContrat'> | null, o2: Pick<ITypeContrat, 'idTypeContrat'> | null): boolean {
    return o1 && o2 ? this.getTypeContratIdentifier(o1) === this.getTypeContratIdentifier(o2) : o1 === o2;
  }

  addTypeContratToCollectionIfMissing<Type extends Pick<ITypeContrat, 'idTypeContrat'>>(
