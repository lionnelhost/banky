...
import { AgenceService, EntityArrayResponseType } from '../service/agence.service';
...
export class AgenceComponent implements OnInit {
  ...
  trackIdAgence = (_index: number, item: IAgence): string => this.agenceService.getAgenceIdentifier(item);
