...
import { sampleWithFullData, sampleWithNewData, sampleWithPartialData, sampleWithRequiredData } from '../canal.test-samples';

import { CanalService } from './canal.service';

const requireRestSample: ICanal = {
