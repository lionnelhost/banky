...
import { AbonneService, EntityArrayResponseType } from '../service/abonne.service';
...
export class AbonneComponent implements OnInit {
  ...
  trackIdAbonne = (_index: number, item: IAbonne): string => this.abonneService.getAbonneIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.abonnes = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IAbonne[] | null): IAbonne[] {
    return data ?? [];
  }
  ...
  protected queryBackend(): Observable<EntityArrayResponseType> {
    ...
    return this.abonneService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
