...
export type PartialUpdateClient = Partial<IClient> & Pick<IClient, 'idClient'>;
...
export class ClientService {
  ...
  getClientIdentifier(client: Pick<IClient, 'idClient'>): string {
    return client.idClient;
  }

  compareClient(o1: Pick<IClient, 'idClient'> | null, o2: Pick<IClient, 'idClient'> | null): boolean {
    return o1 && o2 ? this.getClientIdentifier(o1) === this.getClientIdentifier(o2) : o1 === o2;
  }

  addClientToCollectionIfMissing<Type extends Pick<IClient, 'idClient'>>(
