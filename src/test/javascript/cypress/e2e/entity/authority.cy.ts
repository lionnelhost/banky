...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: 'db249fb6-63c1-492c-9e83-214c7e679eef' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('7f9a9349-50e7-416f-b7ba-368f1eace95b');
      cy.get(`[data-cy="name"]`).should('have.value', '7f9a9349-50e7-416f-b7ba-368f1eace95b');
